...
This is the default structure for a project. It's very basic and you should feel welcome to alter it to your liking. There is another README in the `3-Study/2-Content/2-Media/` folder that explains the extensive structure there.

1. Project Management
    1. Proposals
    1. Finance (grants, et cetera)
    1. Reports
1. Ethics Governance
    1. Ethics Approval (IRB, CITI certification)
    1. Consent Forms (**blank**; completed stored securely)
1. Study
    1. Input/Munge (data loading, cleaning, EDA)
    1. Content
        1. Data (raw and tidied data)
        1. Media (videos, audio, screencasts, so on)
    1. Data Analysis
    1. Outputs
1. Dissemination
